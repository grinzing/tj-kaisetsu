      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        <section className="mx-auto mb-20 max-w-3xl space-y-12 font-serif leading-relaxed tracking-wide">
          ...
          <div className="rounded-lg bg-white p-8 shadow-sm">
            ...
            <p className="mb-4">
              エンディング後『解説ページ』に到達した方を除き、参加者の約70％の皆様は物語の真相に確信を持てないまま物語を終えていることと思います。
            </p>
            <p className="mb-4">
          ...
          <div className="rounded-lg bg-white p-8 shadow-sm">
            ...
            <p className="mb-4">
              その上、水のように見える状態で被験者に持たせれば、施設内を運動中に追加で投与することでより複雑な試験を行うこともできます。重大な証拠でもあるため、大黒はPARCO内の周遊ルートにペットボトルや缶を捨てるゴミ箱などがないことを確認した上で、報酬を渡す前に必ずこのペットボトルや缶を回収しようとするのでした。
            </p>
            <p className="mb-4">
              容器に入っていた無色透明な液体こそが、人の記憶を消去する「オブリビオン」である。この事実は、薬の詳細書類をよく読み、「『剤型』：無味無臭透明液体」などの項目に着目することで気づけるようになっています。
            </p>
            <p className="mb-4">
              また、斉藤との会話の中で「治験はプラセボ薬と並行している」という言葉を聞き、ラインにて検索を行った場合には、プラセボ薬の存在を確信し、もし錠剤がプラセボ薬だとしたら、自分に影響を与えている薬とはなんなんなのか、と考えることもできます。
            </p>
            <p className="mb-4">
